...
Method 2: Check for previous and next characters of current character, if none of them are same then we can add current character in the output string of that
	iteration. Do this till we don't find any consecutively same character in current iteration. 
