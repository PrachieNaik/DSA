...
Problem statement: Given two binary max heaps as arrays, merge the given heaps, after merging the two arrays.
...
Complexity for building the heap from array of n elements is O(n). The complexity of merging the heaps is equal to O(n + m).
